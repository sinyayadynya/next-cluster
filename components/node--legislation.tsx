...
import { GovernmentOrganizationHeader } from 'components/node--government_organization';
// import { OrganizationHeader } from 'components/node--organization';
import { LegislationObject } from 'components/media--legislation_object';
    ...
    return (
        <article {...props}>
            ...
            <section>
                ...
                {node.description?.processed && (
                    <div className="mb-4 prose">
                        <h3 className="mb-1 text-2xl">Summary</h3>
            ...
            <button onClick={() => setIsOpen(!isOpen)}>
                {isOpen ? "Close Section" : "Read full text"}
            </button>
            ...
            {isOpen && (
                <section>
                    {node.legislation_passed_by && (
                        <div className="mb-4">
                            <GovernmentOrganizationHeader
                                entity={node.legislation_passed_by}
                            />
                        </div>
                    )}
            ...
            <section>
                ...
                {node.has_part && (
                    <div className="mb-4">
                        ...
                        <div>
                            {node.has_part.map((media, i) => (
                                <LegislationObject key={i} media={media} />
                            ))}
                        </div>
                    </div>
                )}
            ...
            <section>
                ...
                {node.legislation_date_version && (
                    <div className="mb-4">
                        ...
                        <div>
                            {formatDateTime(node.legislation_date_version)}
                        </div>
                    </div>
                )}
            ...
            <section>
                ...
                {node.field_editorial && (
                    <div className="mb-4">
                        ...
                        <pre>
                            {JSON.stringify(node.field_editorial, null, 2)}
                        </pre>
                    </div>
                )}
            </section>
