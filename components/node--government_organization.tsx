...
interface GovernmentOrganizationProps {
    entity: {
        title: string;
        logo?: {
            id: string;
...
export function GovernmentOrganizationHeader({
    entity,
...
export function NodeGovernmentOrganization({
    node,
    ...props
}: NodeOrganizationProps) {
    return (
        <article {...props}>
            ...
            <section>
                {node.logo && (
                    <div className="mb-4">
                        <h3 className="mb-1 text-2xl">Logo</h3>
                        <div className="w-24 h-auto">
                            <DrupalEntity entity={node.logo} />
                        </div>
                    </div>
                )}
            </section>
